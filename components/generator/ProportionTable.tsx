      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-slate-200">
            ...
            <th className="pb-2 text-right font-semibold text-slate-600">
              Kwota
            </th>
          </tr>
        </thead>
        <tbody className="divide-y divide-slate-100">
          {proposals.map((p) => (
            <tr key={p.work_item_id} className="hover:bg-slate-50">
        ...
        <tfoot>
          <tr className="border-t-2 border-slate-200">
            <td
              colSpan={4}
              className="pt-3 text-sm font-semibold text-slate-600"
            >
              Łącznie
            </td>
            ...
            <td className="pt-3 text-right tabular-nums font-bold text-slate-900">
